...
describe('commandRegistry', () => {
  it('exposes all commands (8 M0 + undo/redo T1 + moveElement/deleteSection T2 + deleteSelection T3 + exportIfc M2-T2 + importIfcModel M2-T3 + reference-document M2-T5) under names matching their keys', () => {
