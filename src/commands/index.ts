 ...
 */
import { checkBarClashes } from './check-bar-clashes';
...
export { checkBarClashes } from './check-bar-clashes';
...
export type { CheckBarClashesParams, CheckBarClashesResult } from './check-bar-clashes';
...
export const commandRegistry = {
  checkBarClashes: { name: 'checkBarClashes', thunk: checkBarClashes },
