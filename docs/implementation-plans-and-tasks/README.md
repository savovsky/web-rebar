...
| M2: Adapters Round-Trip (IFC + DXF — §A revised 2026-08-09, was IFC-only; Q7 amended 2026-08-18: IFC reference solids → T6.5) | [m2-adapters-round-trip.md](./m2-adapters-round-trip.md) | ✅ Complete (T1–T8, 2026-08-18 — all four §A acceptance sentences green headless + author-verified in real CAD; DXF fixture gate satisfied 2026-08-18) |
| M3: Real Bar Placement | [m3-real-bar-placement.md](./m3-real-bar-placement.md) | ✅ Complete (T1–T8, 2026-08-22, branch `A_MVP_Scope_M3` — §F.2 Individual + Group placement with stored rules, edit→regenerate, host-follow + detach; parry3d-f64 adopted via the Q2 gate; clash check non-blocking per §K.4 + the §K.1 on-demand entry; the five §A acceptance sentences durable headless (1–4) + author-run UX probe (5); F3 revisit resolved accept-at-scale with the tripwires armed; §L.1 evidence feeds M4) |
