...
| M2: Adapters Round-Trip (IFC + DXF — §A revised 2026-08-09, was IFC-only; Q7 amended 2026-08-18: IFC reference solids → T6.5) | [m2-adapters-round-trip.md](./m2-adapters-round-trip.md) | 🔵 In progress — T1/T2/T2.5/T3/T4 ✅ (2026-08-18), T5 next (⚠️ T5/T6 fixture gate ✅ satisfied 2026-08-18) |
