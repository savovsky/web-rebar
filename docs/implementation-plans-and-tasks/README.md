...
| M3: Real Bar Placement | [m3-real-bar-placement.md](./m3-real-bar-placement.md) | 🔵 In progress (T1 ✅ data model + project-slice reducers, 2026-08-21; T2 engine math next, branch `A_MVP_Scope_M3`) |
