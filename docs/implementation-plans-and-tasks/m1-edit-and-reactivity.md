...
| T3 | Edit UI: Delete / Ctrl+Z / Ctrl+Shift+Z keybindings + Edit menu (TopBar) + status hints; hover picking (author review addition); scenario file started | manual: keyboard + menu drive undo/redo/delete; guards in editable fields; hover previews click winner | ✅ Done | — |
