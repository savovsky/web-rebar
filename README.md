...
Task: implement the next ⬜ Pending task from the M2 tracker (T1/T2/T2.5/T3 ✅
done — next is T4: File menu + IFC UI wiring; a ready-made prompt with the T3
findings lives in m2-t4-session-prompt.md) on branch A_MVP_Scope_M2,
