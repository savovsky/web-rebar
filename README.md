...
> **Next session:** M1 T3 — edit UI per the approved plan: Delete/Backspace + Ctrl+Z / Ctrl+Shift+Z keybindings (same `isEditableTarget` guard), Edit menu in TopBar with disabled states, status-bar hints; scenario file `docs/test-scenarios/m1-edit-and-reactivity.md` started (rule 7)
