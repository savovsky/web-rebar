...
> **Next session:** M1 T5 — performance probes per the approved plan (§5): full-recompute benchmark (reference-scale project, `selectSectionPrimitives` + bar-mesh regeneration after `moveElement`) + undo-stack memory measurement (Q2-a structural sharing vs the §E estimate). T4 ✅ complete (2026-08-09).
