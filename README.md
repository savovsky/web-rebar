...
Task: implement the next ⬜ Pending task from the M2 tracker (T1/T2/T2.5 ✅
done — next is T3: IFC import adapter; a ready-made prompt with the T2/T2.5
findings lives in m2-t3-session-prompt.md) on branch A_MVP_Scope_M2,
