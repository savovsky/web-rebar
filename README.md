...
Task: implement the next ⬜ Pending task from the M2 tracker (T1 ✅ done —                                                                 
next is T2: IFC export adapter) on branch A_MVP_Scope_M2,                     
