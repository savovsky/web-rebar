...
Task: implement the next ⬜ Pending task from the M2 tracker (start T1 —
web-ifc lazy integration + write-capability spike) on branch A_MVP_Scope_M2,
...
check for the author's real DXF files in test-fixtures/dxf/ (5–6 AutoCAD
exports promised). If none exist, STOP execution and ask me for them — do not
proceed on synthetic fixtures alone.
```
