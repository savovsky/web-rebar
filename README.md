...
Task: implement the next ⬜ Pending task from the M2 tracker (T1/T2/T2.5/T3/T4 ✅
done — next is T5: DXF import core; a ready-made prompt with the T4
findings lives in m2-t5-session-prompt.md) on branch A_MVP_Scope_M2,
...
⚠️ HARD GATE: before starting T5/T6 (DXF import core / background rendering),                                                                 
check for the author's real DXF files in docs/test-fixtures/dxf/ —                                                                 
✅ DELIVERED 2026-08-18 (8 AutoCAD exports, gitignored); verify they are still
present — if missing, STOP execution and ask me for them.
```
